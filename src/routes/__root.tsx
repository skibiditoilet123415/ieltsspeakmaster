...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "IELTS Speaking AI Trainer" },
      { property: "og:description", content: "AI-powered IELTS speaking practice with real test simulation, scoring, and vocabulary." },
